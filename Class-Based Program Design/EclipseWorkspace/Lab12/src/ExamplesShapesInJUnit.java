...
class Circle implements IShape {
    ...
    public boolean equals(Object o) {
    	if (o instanceof Circle) {
    		return this.sameCircle((Circle)o);
    	} else {
    		return false;
    	}
    }
...
class CartPt {
    ...
    public boolean equals(CartPt other) {
...
public class ExamplesShapesInJUnit {
    ...
    public void testCircleContains() { 
    	assertEquals("The contains method for circle does not work properly", false, this.c1.contains(new CartPt(100,100)));
